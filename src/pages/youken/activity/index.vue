  ...
  <div :class="show||show1?'height':''">
    ...
    <div class="pd10">
      ...
      <div class="enroll-wrapper disflex">
        <img src="https://hrotp.com/static/system/image/img02.png" alt="">
        ...
        <div class="disflex share-bottom">
          ...
          <!-- <div class="flex share-btn">
            ...
            <button openType="share" class="flex share-btn">
              <view  class="share-icon">
                <cover-image  mode="widthFix" src="https://hrotp.com/static/system/image/haoyou.png"></cover-image>
              </view>
              <view>分享好友</view>
            </button>
        </div>
...
.activity-table {
  height: 100%;
  margin-bottom: 50px;
  background-image: url('https://hrotp.com/static/system/image/activityBg.png');
